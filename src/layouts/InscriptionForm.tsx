...
import InscriptionConfirmationDialog from "./InscriptionConfirmationDialog";
...
export default function InscriptionForm({ inscriptionData }: Props) {
	const {
		sortedSubjects,
		selectedUC,
		selectedSubjects,
		...
		handleSubjectChange,
	} = useSubjectForm(inscriptionData.availableSubjects);
	...
	return (
		...
		>
			<div className="font-bold">
				<ul>
					<li>UC Disponibles: {inscriptionData.availableUC}</li>
			...
			<div className="ml-auto space-x-2">
				...
				<InscriptionConfirmationDialog
					subjectsToInscribe={subjectsToInscribe}
					availableUC={inscriptionData.availableUC}
