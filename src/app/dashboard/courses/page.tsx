...
export default async function Courses() {
	...
	return (
		<Tabs defaultValue="pending" className="grid w-full grid-cols-1">
			<TabsList className="relative mb-4 flex w-full justify-normal overflow-auto">
			...
			<TabsContent value="registered">
				<Card className="p-4">
					<h2 className="mb-4 text-sm font-medium uppercase text-gray-700 dark:text-zinc-300">
						Materias Inscritas
					</h2>
					<Table>
						<TableHeader>
