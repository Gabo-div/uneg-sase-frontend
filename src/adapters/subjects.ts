import { RegisteredSubject, Subject, registeredSubjectSchema, subjectSchema } from "@/models/subject";
...
export const adaptRegisteredSubjects = (subjects: any[]): RegisteredSubject[] => {
