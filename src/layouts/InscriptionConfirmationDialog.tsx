...
export default function InscriptionConfirmationDialog({
	children,
	subjectsToInscribe,
	availableUC,
	selectedUC,
	...
	return (
		<Dialog>
			...
			<DialogContent>
				<DialogHeader>
					<DialogTitle className="mb-4">Confirmar inscripción</DialogTitle>
				</DialogHeader>
				{!canInscribe ? (
					<Alert
						variant="destructive"
					...
					>
						...
						<AlertDescription>
							No puedes inscribir {selectedUC} UC. Solo tienes {availableUC} UC
							disponibles.
						</AlertDescription>
					</Alert>
				) : null}
