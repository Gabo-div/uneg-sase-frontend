  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: cn("bg-zinc-100 text-zinc-900 dark:bg-zinc-800 dark:text-zinc-50", classNames.day_today),
        day_outside: cn(
        ...
        day_disabled: cn("text-zinc-500 opacity-50 dark:text-zinc-400", classNames.day_disabled),
        day_range_middle: cn(
